...
public class UserVoucherServiceImpl implements UserVoucherService {
	...
	public String useUserVoucher(int uvId) {
		UserVoucher userVoucher = userVoucherDao.findById(UserVoucher.class, uvId);
		if(userVoucher == null) {
			return "00";
		}
	...
	public void deleteUserVoucher(int viId) {
		UserVoucher userVoucher = userVoucherDao.findById(UserVoucher.class, viId);
		...
		userVoucherDao.deleteById(UserVoucher.class, viId);
	}
