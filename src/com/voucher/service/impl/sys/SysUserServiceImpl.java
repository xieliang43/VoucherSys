...
public class SysUserServiceImpl extends BaseServiceImpl<SysUser> implements SysUserService {
	...
	public int getTotalCount() {
		return sysUserDao.getTotalCount(SysUser.class);
	}
	...
	public void save(SysUser user, List<String> roleIds) {
		...
		for (String roleId : roleIds) {
			SysRole role = sysRoleDao.findById(SysRole.class, Integer.valueOf(roleId));
	...
	public void deleteMerchantById(int id) {
		this.deleteById(SysUser.class, id);
	}

	@Override
	public SysUser findMerchantById(int id) {
		return this.findById(SysUser.class, id);
	}
