...
merchantshops = {
	all : ctx + '/cmnMerchantShopAction!loadAll.action',// 加载所有
	save : ctx + "/cmnMerchantShopAction!save.action",//保存
	del : ctx + "/cmnMerchantShopAction!delete.action",//删除
	loadArea: ctx + "/cmnMerchantShopAction!loadAreaByCity.action",
