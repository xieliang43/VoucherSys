...
<script type="text/javascript">
	...
	user = {
		all : ctx + '/sysUserAction!loadAll.action', // 所有用户
		save : ctx + "/sysUserAction!save.action",// 保存用户
		reset : ctx + "/sysUserAction!resetPassword.action",// 重置用户密码
		del : ctx + "/sysUserAction!delete.action",// 删除用户
		myRole : ctx + "/sysUserAction!loadUserRole.action",// 加载某个用户的所有角色
