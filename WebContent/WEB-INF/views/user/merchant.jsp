...
merchant = {
	all : ctx + '/cmnMerchantAction!loadMerchant.action', // 所有用户
	save : ctx + "/cmnMerchantAction!update.action",// 保存用户
	reset : ctx + "/cmnMerchantAction!changeExpPassword.action",// 重置用户密码
